...
v-for="role in roles" :key="role.id"
                ...
                <div class="flex flex-col items-center flex-1" @click="selectRole(role.id)">
                  ...
                  <div class="flex flex-col gap-4 w-full mb-4 flex-1">
                    ...
                    <div class="bg-[var(--primary-200)] rounded-xl p-3">
                      <ul class="space-y-1">
                        <li
v-for="pro in role.pros" :key="pro"
                    ...
                    <div class="bg-[var(--primary-50)] rounded-xl p-3">
                      <ul class="space-y-1">
                        <li
v-for="con in role.cons" :key="con"
                ...
                <div class="flex justify-center mt-auto">
                  <button
class="w-32 text-white font-semibold py-2 rounded-xl 
